...
public class DrawingPanel extends JPanel {
	...
	// Normály trojuhelniku x0, y0, z0 ...
	ArrayList<Double> faceNormals = new ArrayList<>();
	...
	double[] xyzToScreenXY(double x, double y, double z) {
		// Rotace podle osy X (souradnice X se nemeni, souradnici Z nebudeme potrebovat)
	...
	private boolean isTriangleVisible(int i) {
		//i = 3*index trojuhelniku = index do pole normal na x souradnice normaly
		return faceNormals.get(i+2) >= 0;
	}
}
